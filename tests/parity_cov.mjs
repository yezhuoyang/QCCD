...
try {
  void editSrc; void engineSrc;
  globalThis.QCCDEdit = require_(cases.edit_js || path.join(root, 'qccd', 'viz', 'js', 'edit.js'));
  globalThis.QCCD = require_(cases.engine || path.join(root, 'qccd', 'viz', 'engine.js'));
} catch (e) {

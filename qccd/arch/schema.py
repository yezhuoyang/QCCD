...
def export_consumers() -> dict:
    ...
    return {"fields": [
        ...
        F("primitives.<name>.broadcastable", "boolean", False,
          "qccd.verify.rules.r4c_broadcast"),
        ...
        F("control.channels.frame", "string", "path",
          "qccd.verify.rules.r19_lab_frame_channels"),
        F("control.channels.frame_note", "string", None, None),
        ...
        F("control.channels.explicit", "any", None,
          "qccd.arch.control.build_control_plane"),
        F("control.optical.addressing", "string", None,
          "qccd.verify.rules.r4c_broadcast"),
        F("control.optical.per_zone_switch", "boolean", False,
          "qccd.verify.rules.r4c_broadcast"),
